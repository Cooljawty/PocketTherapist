  ...
  group("Entry Creation Tests", () {
    ...
    final List<JournalEntry> entrys = [
      JournalEntry(
          ...
          dateOverride: DateTime(2022, 7, 12),
          tags: [
      ...
      JournalEntry(
          ...
          entryText:
              ...
              'and choices.',
          dateOverride: DateTime(2023, 1, 15),
          tags: [
            Tag(name: 'Calm', color: const Color(0xff90c6d0)),
      ...
      JournalEntry(
          ...
          entryText:
              ...
              'be done.',
          dateOverride: DateTime(2023, 4, 27),
          tags: [
      ...
      JournalEntry(
          ...
          dateOverride: DateTime(2022, 5, 12),
          tags: [
            Tag(name: 'Present', color: const Color(0xffff7070)),
            Tag(name: 'Calm', color: const Color(0xff90c6d0)),
          ]),
    ...
    testWidgets('Plan Button', (WidgetTester tester) async {
      ...
      // Test cancelling dateOverride picker
      await tap(tester, planButton);
      await tap(tester, find.text("Cancel"));

      // Test picking dateOverride and time
      await tap(tester, planButton);
...
// Navigate to the entries panel
    ...
    entries.addAll([
      ...
      JournalEntry(
          ...
          dateOverride: DateTime(2022, 2, 6)),
      JournalEntry(
          title: "asdhfkjn", entryText: '', dateOverride: DateTime(2022, 2, 5)),
      JournalEntry(
          title: "Could be better",
          entryText: 'I am running out of ideas',
          dateOverride: DateTime(2021, 3, 17)),
      JournalEntry(
          title: "11sef sd63", entryText: ';)', dateOverride: DateTime(2021, 3, 5)),
      JournalEntry(
